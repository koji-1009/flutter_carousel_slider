...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AG: x0 => x0.hasFocus(),
      AH: x0 => x0.width,
      AI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      AJ: x0 => x0.disabled,
      ...
      CI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      CJ: (x0,x1) => { x0.max = x1 },
      ...
      HJ: x0 => x0.debugSkipFontRetryDelay,
      ...
      JJ: (x0,x1) => x0.transferFromImageBitmap(x1),
      K: (exn) => {
      ...
      PI: x0 => new Blob(x0),
      PJ: x0 => x0.rasterEndMilliseconds,
      ...
      QJ: x0 => x0.rasterStartMilliseconds,
      ...
      SJ: x0 => x0.canvasKitMaximumSurfaces,
      T: x0 => new Promise(x0),
