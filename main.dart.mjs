...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      DG: x0 => x0.disconnect(),
      DH: x0 => x0.firstChild,
      DI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      DJ: x0 => x0.disabled,
      E: (exn) => {
      ...
      FI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      FJ: (x0,x1) => { x0.max = x1 },
      ...
      KJ: x0 => x0.debugSkipFontRetryDelay,
      L: o => o === undefined,
      LB: () => [],
      ...
      nG: x0 => x0.pressure,
      nH: a => a.pop(),
      nI: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      nJ: x0 => x0.body,
